...
st.set_page_config(page_title="Detección SST - Juan Pablo Pérez", layout="centered")
...
st.markdown(
    "<h1 style='text-align: center; color: #1f77b4;'>🦺 Detección de Seguridad con YOLOv8</h1>",
    unsafe_allow_html=True
)
st.markdown("<h4 style='text-align: center; color: gray;'>Juan Pablo Pérez - Seguridad y Salud en el Trabajo</h4>", unsafe_allow_html=True)
st.markdown("---")
...
# ===== ENTRADA DE IMAGEN =====
st.markdown("### 📷 Sube una imagen para detectar elementos de seguridad:")
...
if entrada:
    try:
        ...
        if boxes:
            ...
            st.info("⚠️ No se detectaron elementos con la confianza seleccionada.")
...
# ===== FOOTER =====
st.markdown("---")
st.markdown("<p style='text-align: center; color: gray;'>Aplicación desarrollada por Juan Pablo Pérez 🧠</p>", unsafe_allow_html=True)
